...
namespace CIP_Tool
{
    public partial class OT : Form
    {
        ...
        public void processname_load()
        {
            ...
            DataTable dtaa = new DataTable();
            obj_processname.process_list_ottool(dtaa);
        ...
        public void empname_list()
        {
            ...
            DataTable dtaa = new DataTable();
            obj_empname.empname_list_basedon_reportingmanager_ottool(dtaa, searchby_reportingmanagername.Text);
        ...
        public void datagridview1_display_overall()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@month", searchby_month.Text);
                    }
                }
                sda.SelectCommand = cmd;
                sda.Fill(dt);
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    if (row.Cells["txtVerified"].Value != null)
                    {
                        if (Convert.ToBoolean(row.Cells["txtVerified"].Value) == true)
                        {
                            ...
                            conn.Open();
                            cmd.Parameters.Clear();
                            cmd.CommandText = "exec usp_ot_datagrid_update_verified_dotnet @RequestID,@LastUpdatedDateTime,@LastUpdatedBy";
        ...
        private void dataGridView1_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                if (myrow.Cells["txtVerified_by_Rag"].Value.ToString() == "Yes" || myrow.Cells["txtClaimSubmitted_by_Rag"].Value.ToString() == "Yes")
                {
